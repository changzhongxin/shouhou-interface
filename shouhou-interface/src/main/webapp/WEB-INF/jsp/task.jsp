    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <section class="col-lg-12 connectedSortable">
                    <div class="nav-tabs-custom">
                        ...
                        <div style="height: 120px"><br>
                            ...
                            <button class="boot">
                                <img src="img/新建文件夹.png"><br>新建文件夹
                            </button>

                            <button class="boot" onclick="addData()">
                                <img src="img/新建数据.png"><br>新建数据
                            </button>

                            <button class="boot" onclick="saveData()">
                            ...
                            ​
                            <div class="btn-group">
                                <button type="button" data-toggle="dropdown" class="boot1" onclick="parseSet()">
                                    <img src="img/解析设置.png"><br>解析设置
                                </button>
                            </div>
                            ...
                            <div style="height: 620px">
                                ...
                                <div style="position: absolute;left: 15%">
                                    ...
                                    <div id="child1">
                                        ...
                                        <a href="#" style="font-size: 0.9em" onclick="loadData()">&nbsp;&nbsp;&nbsp;------ <img src="img/文件拷贝.png" >&nbsp;&nbsp;&nbsp;文本仪器</a> <br>
                ...
                <!-- 表单区域-->
                <div class="nav-tabs-custom" id="tableArea" style="display: none;">
                    <section class="col-lg-10 connectedSortable">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs pull-right">
                                <li class="pull-left header"><h5><b>表单区域</b></h5></li>
                            </ul>
                            <div style="height: 620px">
                                    ...
                                    <div style="overflow-x: scroll;">
                                        ...
                                        <div style="height: 580px">
                                            <table class="table table-bordered" id="dataTable">
                                                <tr>
                                                    <th>序号</th>
                                                    <th id="interType">接口类型</th>
                                                    <th id="interName">接口名称</th>
                                                    <th id="instrName">仪器名称</th>
                                                    <th id="filePath">文件路径</th>
                                                </tr>
                                            </table>
