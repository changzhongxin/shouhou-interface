                ...
                <section class="col-lg-12 connectedSortable">
                    <div class="nav-tabs-custom">
                        ...
                        <div style="height: 120px"><br>
                            ...
                            <button class="boot">
                                <img src="img/新建表.png"><br>新建表
                            </button>
                            <button type="button" class="boot" data-toggle="modal" data-target="#myModal">
                                <img src="img/新建属性.png"><br>新建属性
                            </button>
                            <button class="boot">
                                <img src="img/修改.png"><br>修改属性
                            </button>

                            <button class="boot">
                                <img src="img/删除.png"><br>删除数据
                            </button>
                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="#">
                                <br> <br>
                                <span style="position: relative;left: 15%;font-size: 17px"> 属性名称：<input type="text"
                                                                                                        class="form-text"><br><br></span>
                                <span style="position: relative;left: 15%;font-size: 17px"> 属性类型：<input type="text"
                                                                                                        class="form-text"><br><br></span>
                                <span style="position: relative;left: 15%;font-size: 17px">属性长度：<input type="text"
                                                                                                       class="form-text"><br><br></span>
                                <span style="position: relative;left: 15%;font-size: 17px">属性精度：<input type="text"
                                                                                                       class="form-text"><br><br></span>
                                <br>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-dismiss="modal"
                                            style="position: relative;left: -20%;width: 130px">取消
                                    </button>
                                    <input type="submit" class="btn btn-primary" value="确定"
                                           style="position: absolute;left: 30%;width: 130px">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <section class="col-lg-2 connectedSortable">
                        <div class="nav-tabs-custom">
                            ...
                            <div style="height: 620px">
                                ...
                                <div style="position: absolute;left: 15%" id="tree" class="ztree">
