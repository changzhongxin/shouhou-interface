      ...
      <div class="row">
          ...
          <section class="col-lg-2 connectedSortable">
            <div class="nav-tabs-custom">
              ...
              <div style="height: 620px">
                ...
                <div id="tree" class="ztree" style="width:260px; overflow:auto;position: relative;left: 15%;"></div>
        ...
        <div class="nav-tabs-custom">
          <section class="col-lg-10 connectedSortable">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs pull-right">
                <li class="pull-left header" ><h5><b >样品信息</b></h5></li>
              <span style="position: relative;left: 10%;top: 8px">  输入时查找 <input type="radio" name="radio" value="输入时查找" ></span>
              <sapn style="position: relative;left: 15%;top: 8px">  回车查找 <input type="radio" name="radio" value="回车查找" ></sapn>
               <span style="position: relative;left: 20%;top: 8px">匹配规则  <input type="text" ></span>
              </ul>
              <div style="height: 620px">
