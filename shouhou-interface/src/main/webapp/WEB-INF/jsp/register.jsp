      ...
      <div class="row">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              ...
              <div style="height: 120px"><br>
               ...
               <button class="boot">
                  <img src="img/重命名1.png" ><br>提交数据
                </button>
                <button class="boot">
                  <img src="img/预览.png" ><br>预览
                </button>
                <button class="boot">
                  <img src="img/公式.png" ><br>调用计划
                </button>
                <button class="boot">
        ...
        <div class="nav-tabs-custom">
          <section class="col-lg-2 connectedSortable">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs pull-right">
                <li class="pull-left header"><h5><b>业务登记</b></h5></li>
              </ul>
            ...
            <div class="nav-tabs-custom"><br>
              <div style="height: 700px">
                <div class="col-lg-12 col-xs-12"  >
                  <!--配置区域-->
                  <div style="height: 400px;border-bottom: 2px solid rosybrown">
                    <div>
                      <div class="divs11">单位名称&nbsp;：<input type="text" class="text12" value="重庆市长安汽车股份有限公司江津双福厂"></div> <br>
                      <div class="divs11">详细地址&nbsp;：<input type="text" class="text12" value="重庆市江津区双龙大道986号"></div> <br>
                      <div class="divs11">检测类别&nbsp;：<input type="text" class="text11" value="监督和对比"></div> <br>
                      <div class="divs11">&emsp;&emsp;传真&nbsp;：<input type="text" class="text11" ></div> <br>
                      <div class="divs11">联系人：&emsp;<input type="text" class="text11" value="张天天"></div> <br>
                      <div class="divs11">工程流程：<input type="text" class="text11" value="监督抽查流程"></div> <br>
                      <div class="divs11">&emsp;&emsp;备注：<input type="text" class="text12"></div>
                    </div>
                 <div style="position: absolute;right: 25%;top: 5%">
                   <div class="divs33">&emsp;&emsp;&emsp;企业类型：&nbsp;<input type="text" class="text11"></div><br>
                    <div class="divs33">&emsp;&emsp;&emsp;&emsp;&emsp;电话&nbsp;：&nbsp;<input type="text" class="text11" value="023-49788886"></div><br>
                    <div class="divs33">业务单编号类型&nbsp;：&nbsp;<input type="text" class="text11" value="业务编号"></div><br>
                   <div class="divs33">&emsp;业务受理时间：&nbsp;<input type="text" class="text11" value="2017年12月29日"></div><br>
                  </div>
                  </div>
                  <!--end-->
                  <!-- 表单区域 -->
                  <div  style="overflow-x: scroll;overflow-y: scroll;">
                    ...
                    <div style="height: 280px"><br>
                      <h4 style="position: relative;left: 40%">样品项目</h4><br>
